...
# We do not include categorical_cross_entropy for binary classification (with sigmoid output activation), as it can be covered by softmax with K=2.
...
# Final transformation to make predictions fron the neural network output.
