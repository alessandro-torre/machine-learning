...
epochs = 200
ann_relu = ann(n_features=X.shape[1], n_hidden_layers=2, hidden_layers_size=50, activation='relu')
history_loss, _, _, _ = ann_relu.fit(X, Y, learning_rate=1e-4, reg_rate=0.002, epochs=20000, verbose=True)
